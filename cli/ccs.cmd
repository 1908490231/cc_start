...
REM
REM Why prefer usr\bin\bash.exe over bin\bash.exe:
REM   MINGW64 bin\bash.exe causes Claude Code's hook commands to be parsed by
REM   PowerShell (SessionStart:startup hook error / UnexpectedToken). MSYS
REM   usr\bin\bash.exe avoids this. See cc.cmd for the longer explanation.
REM
