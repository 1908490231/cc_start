; ============================================================================
; CC Start Custom NSIS Installer Template
;
; Derived from : tauri-apps/tauri @ tag `tauri-bundler-v2.8.1`
; Upstream path: crates/tauri-bundler/src/bundle/windows/nsis/installer.nsi
; Upstream URL : https://raw.githubusercontent.com/tauri-apps/tauri/tauri-bundler-v2.8.1/crates/tauri-bundler/src/bundle/windows/nsis/installer.nsi
; Matches Tauri: v2.10.3 (`@tauri-apps/cli` ^2 lockfile resolves here)
; Derived at   : 2026-05-12
;
; Purpose: extends the default NSIS template with an "Install CLI" component
; that deploys cc / cc.cmd / cc.ps1 / ccs.cmd / ccs.ps1 from the bundled
; resources to %USERPROFILE%\.local\bin and adds that directory to HKCU PATH.
;
; Upgrade procedure (when bumping Tauri):
;   1. Look up the new `tauri-bundler` release tag for the bundled Tauri version
;   2. Diff this file against the upstream installer.nsi at that tag
;   3. Cherry-pick upstream changes into this file, preserve CC Start sections
;   4. Update the four header lines above (tag / upstream URL / Tauri / date)
;
; Reference docs (filenames are Chinese on purpose):
;   - PRD       : PRD/桌面端添加cli功能.md
;   - Plan      : Plans/2026-05-11-安装器附带cli实施计划.md
;   - Decisions : Plans/调研笔记/2026-05-11-tauri-nsis-能力清单.md (sections 6, 7)
; ============================================================================
